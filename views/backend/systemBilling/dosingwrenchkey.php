                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-green-sharp bold uppercase">Registro Llave de Dosificación</span>
                                        </div>
                                    </div>
                                    <div class="portlet-body form">
                                        <form role="form" id="systembilling-form-dosingwrenchkey">
                                            <div class="form-body">
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase">Llaves de Dosificación</span>
                                        </div>
                                        <!--<div class="tools"> </div>-->
                                    </div>
                                    <div class="portlet-body">
                                        <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_1">
                                            <thead>
                                                <tr>
                                                    <th class="all">Nº</th>
                                                    <th class="all">Llave de Dosificación</th>
                                            ...
                                            <tbody>
                                                <?Php                                               
                                                   if(isset($this->vDataDosingWrenchKeys) && count($this->vDataDosingWrenchKeys)):
                                                        $vCount = 1;
                                                        for($i=0;$i<count($this->vDataDosingWrenchKeys);$i++):
                                                            echo '<tr>';
                                                                echo '<td>'.$vCount.'</td>';
                                                                echo '<td>'.$this->vDataDosingWrenchKeys[$i]['c_dosingwrenchkey'].'</td>';
                                                                if($this->vDataDosingWrenchKeys[$i]['n_active'] == 0){
                                                                    echo '<td><i class="fa fa-close font-red"></i></td>';
                                                                } else if($this->vDataDosingWrenchKeys[$i]['n_active'] == 1){
                                                                    echo '<td><i class="fa fa-check font-green-jungle"></i></td>';
                                                                } else {
                                                                    echo '<td><i class="fa fa-warning font-yellow-crusta"></i></td>';
                                                                }
                                                                echo '<td>'.date_format(date_create($this->vDataDosingWrenchKeys[$i]['d_datecreate']), 'd/m/Y H:i:s').'</td>';
                                                                echo '<td><a href="'.BASE_VIEW_URL.'systemBilling/'.$this->vDataDosingWrenchKeys[$i]['n_coddosingwrenchkey'].'" class="btn green" ><i class="fa fa-print"></i> Visualizar </a></td>';
                                                            ++$vCount;
                                                        endfor;
                                                    endif;
                                                ?>
