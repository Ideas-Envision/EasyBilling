var AccessJScripts = function() {
    ...
    localStorage.setItem(globalURLEasyBilling, 'http://localhost/easybilling/');
    var globalURLEasyBilling = localStorage.getItem(globalURLEasyBilling);
        ...
        var LoginScript = function() {
            $('#access-form-login').submit(function(event){
                ...
                $.ajax({
                    url: globalURLEasyBilling + 'access/LoginMethod/',
                    data: data,
                    processData: false,
                    contentType: false,
                    type: 'POST',
                    ...
                    success: function(resultLoginMethod){
                        ...
                        if(resultLoginMethod == 0){
                            ...
                            window.location = globalURLEasyBilling + 'dashboard';
        ...
        var RegisterScript = function() {
            $('#access-form-register').submit(function(event){
                ...
                var data = new FormData(this);
                $.ajax({
                    url: globalURLEasyBilling + 'access/RegisterMethod/',
                    data: data,
                    processData: false,
                    contentType: false,
                    type: 'POST',
