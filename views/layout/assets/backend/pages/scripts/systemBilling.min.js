var SystemBillingJScripts = function() {
    ...
    var globalURLEasyBilling = localStorage.getItem(globalURLEasyBilling);
        ...
        var RegisterAutorizationCode = function(){
            
            $('#systembilling-form-autorizationcode').submit(function(event){
                //alert('enviar form');
                var data = new FormData(this);
                $.ajax({
                    ...
                    success: function(resultado){
                    alert(resultado);
                       window.location = globalURLEasyBilling + 'systemBilling/autorizationcode/';
                    }
                });
            event.preventDefault();              
            });
        ...
        var RegisterDosingWrenchKey = function(){
            
            $('#systembilling-form-dosingwrenchkey').submit(function(event){
                //alert('enviar form');
                var data = new FormData(this);
                $.ajax({
                    url: globalURLEasyBilling + 'systemBilling/registerDosingWrenchKey/',
                    data: data,
                    processData: false,
                    contentType: false,
                    type: 'POST',
                    ...
                    success: function(resultado){
                    alert(resultado);
                       window.location = globalURLEasyBilling + 'systemBilling/dosingwrenchkey/';
                    }
                });
            event.preventDefault();              
            });
	...
	return {
		init: function() {
			ConfirmRegisterBilling(), RegisterNewBilling(), BillingDetailDataInsert(), BillingDetailDelete(), BillingActivityDetail(), GenerateFileCiclicProcess(), RegisterAutorizationCode(), RegisterDosingWrenchKey();
		}
	}
}();
